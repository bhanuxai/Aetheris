  ...
  return (
    <section className="py-32 px-6 border-b border-arctic-powder/5 bg-oceanic-noir/50 relative overflow-hidden" id="about-system">
      <div className="max-w-4xl mx-auto">
        ...
        >
          AETHERIS BUILDS DECENTRALIZED DATA PIPELINES CONNECTING REAL-TIME TRANSACTION LOGS TO LOCALIZED GPU VECTOR MODELS. CHOOSE YOUR CONSOLE, REFLECT YOUR ENDPOINTS AT THE EDGE, AND INGEST DB SCHEMAS DYNAMICALLY WITHOUT SYSTEM LATENCY. ACTIVATED BY ALEX CRISTACHE UNDER CLUSTER NODE KEY MP025.
        </ScrollReveal>
      </div>
    </section>
  );
